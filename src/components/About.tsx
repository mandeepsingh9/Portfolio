...
const aboutSections = [
  ...
  },
  {
    ...
    title: "What I Do",
    description: [
      "Develop high-performance web apps and also Mobile App  using modern tech stacks.",
      ...
      <div className="container mx-auto px-6 relative">
        ...
        <div className="max-w-5xl mx-auto mb-16 text-center">
          <p className="text-base sm:text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
            Hey there! 👋 I'm <span className="text-blue-600 font-semibold">Mandeep Kumar</span>,
